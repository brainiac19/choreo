...
const UUID = process.env.UUID || 'e7345c04-1ce1-4319-a9f0-607b4f1ae4a9'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreo-xary-us.agno.win';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiZmQ5YmRhZWM1OTg3ZmZiZWNhNzAyN2Q2YTlmYTAzYmQiLCJ0IjoiNzI0NDM4NTktM2FjNy00N2Q5LWE5ZjktNDYwYzBlZmVhMTE3IiwicyI6Ik1tSmlaV0l3WlRndE5qTmxOUzAwTkdGbUxUazRNVE10WkRBMk1HVXhZV1prT0RrNSJ9';
const CFIP = process.env.CFIP || 'cf.agno.win';
